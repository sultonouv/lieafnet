"""
Training/eval config for LiEAF-Net on ISPRS Vaihingen.
Reproduces the paper's main result: 83.59% mIoU / 90.86% mF1 / 93.36% OA.

Run from the repo root, e.g.:
    python train_supervision.py -c config/vaihingen/lieafnet.py
    python vaihingen_test.py -c config/vaihingen/lieafnet.py -o fig_results/vaihingen/lieafnet --rgb

See README.md "Data preparation" for how to populate data/vaihingen/.
"""
from pathlib import Path
from torch.utils.data import DataLoader
from geoseg.losses import *
from geoseg.datasets.vaihingen_dataset_ import *
...
DROOT = str(REPO_ROOT / "data" / "vaihingen")
